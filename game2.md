...
import Character from "/Team-Project/myScripts/GameScripts/CharacterMovement.js";
import Object from "/Team-Project/myScripts/GameScripts/CreateObject.js";
import light from "/Team-Project/myScripts/GameScripts/Lights.js";
import {Display, subDisplay} from "/Team-Project/myScripts/GameScripts/Displays.js";

//create objects
//E key animation
        var EkeyImage = new Image ();
            EkeyImage.src = "/Team-Project/images/Game/EKeySprite.png"
...
////////Part 1
   //main character
    ...
    characterSpriteSheet.src = "/Team-Project/images/Game/walking-sprite2.png";
    ...
    //backgrounds
        ...
        //boxes
            ...
            boxstackImage.src = "/Team-Project/images/Game/box2.png"
...
////////Part 1
    ...
    //background
        ...
        hallwaySprite.src = "/Team-Project/images/Game/room2.png"
...
////////Credits
    //objects
        ...
        squidSprite.src = "/Team-Project/images/Game/squid.png";
...
window.addEventListener('keydown',function(e){
        if (e.code === "KeyE") {
            ...
            if (overBed && flag2 == true){
                ...
                part1Display.draw();
                mainDisplay.draw();
                window.open("/Team-Project//c4.1/2023/10/31/MiniGametest5.html")
