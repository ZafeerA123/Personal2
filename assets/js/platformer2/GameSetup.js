    ...
    */
    ...
    assets: {
      ...
      platforms: {
        ...
        itemBlock: {
          src: "/images/platformer2/platforms/mario_block_spritesheet_v2.png",
          sizeRatio: 83.2,
          widthRatio: 0.5,
          heightRatio: 1.0,
          width: 204,
      ...
      backgrounds: {
        ...
        complete2: { src: "/images/platformer2/backgrounds/TwoStar.png" },
        end: { src: "/images/platformer2/backgrounds/Congratulations!!!.png" }
      },
      players: {
        mario: {
          src: "/images/platformer2/sprites/mario.png",
          width: 256,
          height: 256,
          scaleSize: 80,
          speedRatio: 0.7,
        ...
        lopez: {
          src: "/images/platformer2/sprites/lopezanimation.png", 
          width: 46,
          height: 52.5,
          scaleSize: 60,
          speedRatio: 0.7,
      ...
      enemies: {
        goomba: {
          src: "/images/platformer2/sprites/goomba.png",
          width: 448,
          height: 452,
          scaleSize: 60,
          speedRatio: 0.7,
